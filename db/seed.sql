...
('Microsoft', 4, 4, 5,'Web Developer Contract', '$57-$63(hr)'),
('Microsoft', 4, 4, 5,'Full Stack Developer', '$54k-$123k');

INSERT INTO companies (company_name,Irating,Grating,Drating,position,salary) VALUES ('Charter Global Inc.', 3.5, 3.5, 5, 'Software Engineer', '$80k-$102k'),
('Charter Global Inc.', 3.5, 3.5, 5, 'Software Engineer(Hr)', '$26k-$40k(hrly avg)'),
('Charter Global Inc.', 3.5, 3.5, 5, 'Software Engineer Contract', '$31-$98k(hrly avg)'),
('Charter Global Inc.', 3.5, 3.5, 5, 'Web Developer', '$74k-$80k'),
('Charter Global Inc.', 3.5, 3.5, 5, 'Web Developer Contract', '$25-$43(hrly avg)'),
('Charter Global Inc.', 3.5, 3.5, 5, 'Full Stack Developer', '$53k-$75k(avg)');

INSERT INTO companies (company_name,Irating,Grating,Drating,position,salary) VALUES ('Delta', 4, 4, 5,'Software Engineer', '$67k-$73k'),
('Delta', 4, 4, 5,'Software Engineer(Hr)', '$26-$40(hrly avg)'),
('Delta', 4, 4, 5,'Software Engineer Contract', '$31-$98(hrly avg)'),
('Delta', 4, 4, 5,'Web Developer', '$74k-$80k'),
('Delta', 4, 4, 5,'Web Developer Contract', '$25-$43(hrly avg)'),
('Delta', 4, 4, 5,'Full Stack Developer', '$53k-$75k(avg)');

INSERT INTO companies (company_name,Irating,Grating,Drating,position,salary) VALUES ('UPS', 4, 3.5, 5,'Software Engineer', '$67k-$73k'),
('UPS', 4, 3.5, 5,'Software Engineer(Hr)', '$15-$41'),
('UPS', 4, 3.5, 5,'Software Engineer Contract', '$70k-$75k'),
('UPS', 4, 3.5, 5,'Web Developer', '$55k-$84k'),
('UPS', 4, 3.5, 5,'Web Developer Contract', '$22-$63'),
('UPS', 4, 3.5, 5,'Full Stack Developer', '$52k-$56k');

INSERT INTO companies (company_name,Irating,Grating,Drating,position,salary) VALUES ('The Home Depot', 4, 3.5, 5, 'Software Engineer', '$62k-$144k'),
('The Home Depot', 4, 3.5, 5, 'Software Engineer(Hr)', '$20-$42'),
('The Home Depot', 4, 3.5, 5, 'Software Engineer Contract', '$$75k-$120k'),
('The Home Depot', 4, 3.5, 5, 'Web Developer', '$51-$95k'),
('The Home Depot', 4, 3.5, 5, 'Web Developer Contract', '$25-$43(hrly avg)'),
('The Home Depot', 4, 3.5, 5, 'Full Stack Developer', '$91k-$100k');

INSERT INTO companies (company_name,Irating,Grating,Drating,position,salary) VALUES ('Booz Allen Hamilton', 4, 4, 5, 'Software Engineer', '$87k-$95k'),
('Booz Allen Hamilton', 4, 4, 5, 'Software Engineer(Hr)', '$26-$40(hrly avg)'),
('Booz Allen Hamilton', 4, 4, 5, 'Software Enginee Contract', '$31-$98(hrly avg)'),
('Booz Allen Hamilton', 4, 4, 5, 'Web Developer', '$82k-$89k'),
('Booz Allen Hamilton', 4, 4, 5, 'Web Developer Contract', '$25-$43(hrly avg)'),
('Booz Allen Hamilton', 4, 4, 5, 'Full Stack Developer', '$53k-$75k(avg)');

INSERT INTO companies (company_name,Irating,Grating,Drating,position,salary) VALUES ('SunTrust', 3.5, 4, 5, 'Software Engineer', '$41k-$115k'),
('SunTrust', 3.5, 4, 5, 'Software Engineer(Hr)', '$26-$40(hrly avg)'),
('SunTrust', 3.5, 4, 5, 'Software Engineer Contract', '$31-$98(hrly avg)'),
('SunTrust', 3.5, 4, 5, 'Web Developer', '$82k-$89k'),
('SunTrust', 3.5, 4, 5, 'Web Developer Contract', '$25-$43(hrly avg)'),
('SunTrust', 3.5, 4, 5, 'Full Stack Developer', '$53k-$75k(avg)');

INSERT INTO companies (company_name,Irating,Grating,Drating,position,salary) VALUES ('Deloitte', 4, 4, 5, 'Software Engineer', '$65k-$182k'),
('Deloitte', 4, 4, 5, 'Software Engineer(Hr)', '$26-$40(hrly avg)'),
('Deloitte', 4, 4, 5, 'Software Engineer Contract', '$31-$98(hrly avg)'),
('Deloitte', 4, 4, 5, 'Web Developer', '$56k-$110k'),
('Deloitte', 4, 4, 5, 'Web Developer Contract', '$51-55'),
('Deloitte', 4, 4, 5, 'Full Stack Developer', '$53k-$75k(avg)');

INSERT INTO companies (company_name,Irating,Grating,Drating,position,salary) VALUES ('Anthem Inc.', 3.5, 3, 5, 'Software Engineer', '$70-$133k'),
('Anthem Inc.', 3.5, 3, 5, 'Software Engineer(Hr)', '$70-$133k'),
('Anthem Inc.', 3.5, 3, 5, 'Software Engineer Contract', '$70-$133k'),
('Anthem Inc.', 3.5, 3, 5, 'Web Developer', '$70-$133k'),
('Anthem Inc.', 3.5, 3, 5, 'Web Developer Contract', '$70-$133k'),
