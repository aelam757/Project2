// Home Page = Input Company Name page

// User can enter company name. If company name is recognized (company name matches with company in database) then the field will auto-fill.
